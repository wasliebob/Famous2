...
public class Creeper2 extends EntityMob
{
    /**
    ...
    public Creeper2(World i)
    {
        super(i);
        this.texture = "/mods/Famous/textures/model/creeper2.png";
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new CreeperAttack(this));
