...
public class BudderCow extends EntityCow
{
    public BudderCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/Famous/textures/mobs/gc.png";
     ...
     */
    public BudderCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new BudderCow(this.worldObj);
    }
