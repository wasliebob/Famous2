...
public class BossFox extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    public BossFox(World par1World)
    {
        super(par1World);
        this.setEntityHealth(this.getMaxHealth());
        this.texture = "/mods/Famous/textures/fox.png";
    ...
    {
        return "/mods/Famous/textures/mobs/fox.png";
    }
    ...
    public void onLivingUpdate()
    {
        ...
        for (j = 0; j < 3; ++j)
        {
            ...
            this.worldObj.spawnParticle("flame", d8 + this.rand.nextGaussian() * 0.30000001192092896D, d9 + this.rand.nextGaussian() * 0.30000001192092896D, d10 + this.rand.nextGaussian() * 0.30000001192092896D, 0.0D, 0.0D, 0.0D);
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6, boolean par8)
    {
        ...
        double d7 = par4 - d4;
        double d8 = par6 - d5;
        EntityFireBall entitywitherskull = new EntityFireBall(this.worldObj, this, d6, d7, d8);

        if (par8)
        {
            entitywitherskull.setInvulnerable(false);
        }
    ...
    {
        this.dropItem(Famous.hd.itemID, 1);
    }
