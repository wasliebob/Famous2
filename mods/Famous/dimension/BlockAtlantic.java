...
public class BlockAtlantic extends BlockPortal {

        public BlockAtlantic(int id) {
                super(id);
                
             // Constructor Configuration
                setCreativeTab(Famous.tabCustom);
                setUnlocalizedName("Famous:atlantic");
                setResistance(5.0F);
                setBlockUnbreakable();
        }
        ...
        {
                 blockIcon = iconRegister.registerIcon("Famous:atlantic");
        }
        ...
        if (par5Entity.dimension != Famous.dimension2)
        {
        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Famous.dimension2, new TeleporterA(thePlayer.mcServer.worldServerForDimension(Famous.dimension2)));
        }
        else
        {
        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterA(thePlayer.mcServer.worldServerForDimension(0)));
        }
        }
        }
        }
