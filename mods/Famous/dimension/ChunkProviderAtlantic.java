...
public class ChunkProviderAtlantic implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderAtlantic(World par1World, long par2, boolean par4)
    {
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                int j1 = -1;
                byte b1 = (byte) Block.waterStill.blockID;
                byte b2 = (byte) Block.waterStill.blockID;
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == Block.waterStill.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)Block.waterStill.blockID;
                                }
                            ...
                            else if (j1 > 0)
                            {
                                ...
                                if (j1 == 0 && b2 == Block.waterStill.blockID)
                                {
    ...
    public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4)
    {
        ...
        return biomegenbase == null ? null : (biomegenbase == Famous.AtlanticBiome && par1EnumCreatureType == EnumCreatureType.monster && this.scatteredFeatureGenerator.hasStructureAt(par2, par3, par4) ? this.scatteredFeatureGenerator.getScatteredFeatureSpawnList() : biomegenbase.getSpawnableList(par1EnumCreatureType));
    }
