...
public class TeleporterA extends Teleporter
{
...
public TeleporterA(WorldServer par1WorldServer)
{
...
{
if (this.field_85192_a.getBlockId(var48, var26, var23) == Famous.portal.blockID)
{
while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Famous.portal.blockID)
{
--var26;
}
...
if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Famous.portal.blockID)
{
var50 = 2;
}
...
if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == Famous.portal.blockID)
{
var50 = 3;
}
