...
public class BlockAnime extends BlockPortal {

        public BlockAnime(int id) {
                super(id);
                
             // Constructor Configuration
                setCreativeTab(Famous.tabCustom);
                setUnlocalizedName("Famous:a");
                setResistance(5.0F);
                setBlockUnbreakable();
        }
        ...
        {
                 blockIcon = iconRegister.registerIcon("Famous:a");
        }
        ...
        if (par5Entity.dimension != Famous.dimension)
        {
        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Famous.dimension, new TeleporterA(thePlayer.mcServer.worldServerForDimension(Famous.dimension)));
        }
        else
        {
