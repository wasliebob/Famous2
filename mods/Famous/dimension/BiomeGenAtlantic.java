...
public class BiomeGenAtlantic extends BiomeGenBase
{
       public BiomeGenAtlantic(int par1)
       {
             super(par1);
       }
       ...
       {
    	   this.topBlocke = (byte)Block.waterStill.blockID;
           this.fillerBlocke = (byte)Block.waterStill.blockID;
           ...
           this.biomeIDe = par1;
           biomeList[par1] = Famous.AtlanticBiome;
           this.theBiomeDecorator = this.createBiomeDecorator();
           this.spawnableMonsterListe.add(new SpawnListEntry(Joebuz.class, 1, 1, 4));
       }
}