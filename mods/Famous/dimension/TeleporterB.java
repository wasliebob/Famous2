...
public class TeleporterB extends Teleporter
{
...
public TeleporterB(WorldServer par1WorldServer)
{
...
{
if (this.field_85192_a.provider.dimensionId != 2)
{
...
{
if (this.field_85192_a.getBlockId(var48, var26, var23) == Famous.AtlanticPortal.blockID)
{
while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Famous.AtlanticPortal.blockID)
{
--var26;
}
...
if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Famous.AtlanticPortal.blockID)
{
var50 = 2;
}
...
if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == Famous.AtlanticPortal.blockID)
{
var50 = 3;
}
