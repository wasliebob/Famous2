...
public class LiquidButterStill extends Block
{
    @SideOnly(Side.CLIENT)
    public static Icon[] theIcon;

    public LiquidButterStill(int par1, Material par2Material)
    {
        ...
        this.setCreativeTab(Famous.tabHD);
        this.setUnlocalizedName("Famous:lb");
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
            ...
            this.theIcon = new Icon[] {par1IconRegister.registerIcon("Famous:lb"), par1IconRegister.registerIcon("Famous:lb")};
    }
