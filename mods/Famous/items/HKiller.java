...
public class HKiller extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public HKiller(int ID, EnumToolMaterial material,  String name)
{
...
this.setCreativeTab(Famous.tabSword);
this.weaponDamage = 50 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
this.setUnlocalizedName("Famous:hk");
}
...
public boolean hitEntity(ItemStack itemstack, EntityLiving entityliving, World world, PotionEffect potion, EntityMob mob, int x, int y, int z, int l, float f)
{
...
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:hk");
