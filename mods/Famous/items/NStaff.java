...
public class NStaff extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public NStaff(int ID, EnumToolMaterial material,  String name)
{
...
this.weaponDamage = 2 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
this.setUnlocalizedName("Famous:nstaff");
}
...
{
return Famous.aingot.itemID == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
}

//texture
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:nstaff");
