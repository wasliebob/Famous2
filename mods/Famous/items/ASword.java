...
public ASword(int ID, EnumToolMaterial material,  String name)
{
...
this.setUnlocalizedName("Famous:asword");
}
...
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:asword");
