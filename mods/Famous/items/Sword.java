...
public Sword(int ID, EnumToolMaterial material,  String name)
{
...
this.setUnlocalizedName("Famous:gsword");
}
...
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:gsword");
