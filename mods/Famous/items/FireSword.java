...
public FireSword(int ID, EnumToolMaterial material,  String name)
{
...
this.setUnlocalizedName("Famous:fsword");
}
...
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:fsword"); 
}
