...
public SSword(int ID, EnumToolMaterial material,  String name)
{
...
this.setUnlocalizedName("Famous:ssword");
...
{
return Famous.squid.itemID == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
}
public void updateIcons(IconRegister par1IconRegister) {
    this.itemIcon = par1IconRegister.registerIcon("Famous:ssword");
