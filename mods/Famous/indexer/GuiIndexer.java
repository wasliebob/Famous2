...
public class GuiIndexer extends GuiContainer
{
    ...
    public GuiIndexer(IInventory par1IInventory, IInventory par2IInventory)
    {
    ...
    public void initGui() {
            ...
            buttonList.add(new GuiButton(1, 30, 10, 80, 20, "Info"));
    }

    public void actionPerformed(GuiButton button)
    {
    	this.mc.thePlayer.closeScreen();
    	this.mc.thePlayer.sendChatToPlayer("The Indexer is a chest for all you're Famator stuff.");
    }
}
