...
public class TileEntityFamator extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                TileEntityFamator.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = RecipesFamator.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (i == Famous.FamousItem.itemID) return 40;
            if (i == Famous.squid.itemID) return 40;
            if (i == Famous.jerry.itemID) return 40;
            if (i == Famous.heal.itemID) return 50000;
